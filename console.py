...
class HBNBCommand(cmd.Cmd):
    ...
    def do_create(self, args):
        ...
        # this splits arguments with whitespace as delimeter
        ...
        # helps to Form Key Value pairs with the remaining parameters
        attributes = {}
        for param in command_list[1:]:
            ...
            key.strip()
            # this Verifies the type of value
            if value[0] == '"':
                # it removes leading & trailing[whitespace & double quotes]
                value = value.strip(' "')
                # this escape double quotes using a backslash
                value = value.replace('"', '//"')
